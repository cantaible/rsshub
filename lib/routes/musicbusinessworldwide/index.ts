...
const baseUrl = 'https://www.musicbusinessworldwide.com';
...
export const route: Route = {
    ...
    example: '/musicbusinessworldwide',
    radar: [
        {
            source: ['www.musicbusinessworldwide.com/'],
            target: '/musicbusinessworldwide',
        },
    ],
    name: 'Latest',
    maintainers: ['cantaible'],
    handler,
    url: 'www.musicbusinessworldwide.com/',
    description: 'Latest news from Music Business Worldwide.',
};
